...
function out = PMA(varargin)
%PMA Dose profile after bolus administration of PMA.
%   
%   INPUTS:
%   u: [scalar] normalized dose, fraction of 1.
%   t: [vector] time points at which activity should be simulated (t>=0).
...
function out = PP1(varargin)
%PP1 Dose profile after bolus administration of PP1.
%   
%   INPUTS:
%   u: [scalar] normalized dose, fraction of 1.
%   t: [vector] time points at which activity should be simulated (t>=0).
