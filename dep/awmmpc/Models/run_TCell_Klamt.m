function [T,X] = run_TCell_Klamt(t,x0,p,u,t_admin,models,tn,drugs)
%RUN_TCELL_KLAMT Simulate ODEs for T cell model developed by Klamt (2006).
...
%   
%   SYNTAX:
%   [T,X] = run_TCell_Klamt(t,x0,p,u,t_admin,models,tn,drugs)
%   
%   INPUTS:
...
if isempty(x0), x0 = TCell_Klamt; end
...
opt = [];%odeset('Vectorized','off','NonNegative',1:length(x0));
[T,X] = ode15s(@TCell_Klamt,tspan,x0,opt,P,u,drugs);
