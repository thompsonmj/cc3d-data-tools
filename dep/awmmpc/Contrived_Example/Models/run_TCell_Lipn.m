function [T,X] = run_TCell_Lipn(t,x0,p,u,t_admin,models,tn,drugs)
%RUN_TCELL_Lipn Simulate ODEs for T cell model developed by Lipniacki.
...
%   
%   SYNTAX:
%   [T,X] = run_TCell_Lipn(t,x0,p,u,t_admin,models,tn,drugs)
%   
%   INPUTS:
...
if isempty(x0), x0 = TCell_Lipn; end
...
[T,X] = ode15s(@TCell_Lipn,tspan,x0,opt,P,u,drugs);
