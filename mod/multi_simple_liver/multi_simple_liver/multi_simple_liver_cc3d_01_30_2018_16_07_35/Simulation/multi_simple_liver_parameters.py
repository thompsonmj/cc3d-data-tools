...
cc3d_iterODE = 5  # best = 5, Default = 1. If 5, then CC3D will divide the transfer ODE calc's into 5 substeps
...
cc3d_mcs2second = 0.2 # Best = 0.5, Default = 1.0 simulated second per mcs (second/mcs), if 0.5 then 2 mcs per simulated second
...
# cc3d_k_AT_APAPG	= 0.00009 # 1/s  0.000450  1/30
# cc3d_k_AT_APAPS	= 0.00040 # 1/s  0.001900

cc3d_Km_AT_APAP	 = 0.00100	 # mmol/L  0.010
cc3d_Vmax_AT_APAP= 0.00030	 # mmol/L/s  0.010  0.005 0.00010 0.00030 #######1/26/18#######
