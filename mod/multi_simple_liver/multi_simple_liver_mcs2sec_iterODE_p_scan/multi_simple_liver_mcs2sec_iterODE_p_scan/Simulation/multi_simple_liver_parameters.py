...
cc3d_iterODE = 1  # Default = 1. If 5, then CC3D will divide the transfer ODE calc's into 5 substeps

# conversion factor for CC3D mcs to simulated time
cc3d_mcs2second = 1 # Default = 1.0 simulated second per mcs (second/mcs), if 0.5 then 2 mcs per simulated second
...
X1=0.0	# 	
##### N E W ##################### Jan 2018
bloodVolume = 1.0e-15 # Liter, this is the blood volume in a hep long sinusoid,
...
cc3d_Km_AT_APAP	= 0.010	 # mmol/L
cc3d_Vmax_AT_APAP=0.010	 # mmol/L/s  0.010  0.005 ##############
